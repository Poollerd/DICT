...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('computer', '0005_rename_addupdatecomputer_updatecomputer'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('computer_upgrade_year', models.CharField(max_length=4, verbose_name='Upgrade เครื่อง พ.ศ.?')),
                ...
                ('computer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='upgradecomputers', to='computer.computer')),
                ('created_by', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='upgradecomputers', to=settings.AUTH_USER_MODEL)),
                ('team_name', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='upgradecomputers', to='team.team')),
            ],
        ),
